...
def main():
        ...
        if csv_path.exists():
            try:
                ...
                if len(done_alphas) == len(alphas):
                    ...
                    plot_heterogeneity(accumulated_means, methods_display, alphas, outdir / "heterogeneity.png", proposed_label=proposed_label)
                    return
                elif done_alphas:
    ...
    plot_heterogeneity(means, methods_display, alphas, outdir / "heterogeneity.png", proposed_label=proposed_label)
